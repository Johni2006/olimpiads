...
function showEditQuestionModal(questionId) {
    // Функция showEditModal определена в этом же файле ниже (код из edit.js объединен)
...
// =========================
// Функции редактирования вопросов (из edit.js)
// =========================

// Конфигурация API (должна совпадать с app.js)
// const API_URL уже объявлена выше
